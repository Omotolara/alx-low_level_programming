...
/**
 * word_count - counts the num. of words separated by spaces in a string
 * @str: the string
 *
 * Return: num. of words;
 */
...
/**
 * find_words_len - finds the length of all the words in a string
 * @str: the string
 * @words: num. of words
 *
 * Return: the combined length of words
 */
